...
values ('Сырники', 220, 1, './images/products/1sirniki.png', '200гр, творог, льняная мука, рисовая мука, изюм, курага, сироп топинамбура'),
       ...
       ('Банан-апельсин 300мл', 200, 12, 'c464a5.jpg', '300мл, Вода, банан, корица, апельсин'),
       ('Ягодный микс 300мл', 270, 12, 'caeb097bd38349267fb0a816bc3a775f.jpg', '300мл, Клубника, малина, банан, клюква, яблоко'),
       ('Черника-банан 300мл', 200, 12, 'Smuzi-s-chernikoj-bananom-i-avokado-1.jpg', '300мл, Вода, банан, черника'),
       ('Микс с имбирем 300мл', 250, 12, '960m.jpg', '300мл, Вода, банан, груша, яблоко, киви, корень имбиря, мята, шпинат'),

       ('Морковный 300мл', 140, 13, 'morkovny-sok1.jpg', '300мл'),
       ('Яблочный 300мл', 140, 13, 'd621832e9d12a3f50bd7_800x800.jpg', '300мл'),
       ('Апельсиновый 300мл', 200, 13, 'sok_apels.jpg', '300мл'),
       ('Грейпфрутовый 300мл', 200, 13, 'b6bb9eb2.jpg', '300мл'),
       ('Грушевый 250мл', 170, 13, '960m (1).jpg', '250мл'),
       ('Яблоко-сельдерей 300мл', 170, 13, 'celery_juice_01-kopiya-700x474.jpg', '300мл'),
       ('Яблоко-морковь 300мл', 170, 13, 'yablok.jpg', '300мл');
